...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		levelInfo.setFormat(Paths.font("ComicSansMSBold.ttf"), 32);
		...
		blueballedTxt.setFormat(Paths.font('ComicSansMSBold.ttf'), 32);
		blueballedTxt.updateHitbox();
		add(blueballedTxt);

		practiceText = new FlxText(20, 15 + 101, 0, "PRACTICE MODE", 32);
		practiceText.scrollFactor.set();
		practiceText.setFormat(Paths.font('ComicSansMSBold.ttf'), 32);
		...
		chartingText.setFormat(Paths.font('ComicSansMSBold.ttf'), 32);
		...
		if (accepted && (cantUnpause <= 0 || !ClientPrefs.controllerMode))
		{
			...
			switch (daSelected)
			{
				...
				case "Exit to menu":
					...
					if (PlayState.SONG.song.toLowerCase() == "crumb-edition-v2")
