...
class TitleState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (gfDance != null && FlxG.mouse.overlaps(gfDance) && FlxG.mouse.justPressed)
		{
			FlxG.mouse.visible = false;
			pressedEnter = false;
			var curDifficulty = 2;
			var songLowercase:String = Paths.formatToSongPath("Crumb-Edition-V2");
	...
	override function beatHit()
	{
		...
		if (!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['The Crumb Mod Team'], 15);
					#else
				...
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['A fanmade mod of'], -40);
					#else
				...
				// credTextShit.text += '\nDave and Bambi';
				case 16:
					addMoreText('Crumb Edition'); // credTextShit.text += '\nCrumb Edition';
