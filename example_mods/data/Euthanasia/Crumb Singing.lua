...
idle_xml_name = 'crumb idle0'
left_xml_name = 'crumb left0'
down_xml_name = 'crumb down0'
up_xml_name = 'crumb up0'
right_xml_name = 'crumb right0'
...
name_of_character_xml = 'crumb'
name_of_character = 'crumbly_scrumbly'
