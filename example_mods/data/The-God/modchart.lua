...
function onUpdate(elapsed)
	...
	if notetime <= azazazazazazazazazazaza + 3 then
		if notetime >= lastconductorpos then
			...
			noteTweenDirection('azazaza04', 0, (90 * ( -thecool[downscroll]) / 0.7) + thecool2[downscroll], 6.974023,
				'sineInOut')
	...
	if notetime <= azazazazazazazazazazaza + 3 then
		if notetime >= lastconductorpos then
			...
			noteTweenDirection('azazaza44', 4, (90 * ( -thecool[downscroll]) / 0.7) + thecool2[downscroll], 2.849023,
				'sineInOut')
	...
	if notetime <= azazazazazazazazazazaza + 3 then
		if notetime >= lastconductorpos then
			...
			noteTweenDirection('azazaza34', 3, (90 * ( -thecool[downscroll]) / 0.7) + thecool2[downscroll], 3.162773,
				'sineInOut')
	...
	if notetime <= azazazazazazazazazazaza + 3 then
		if notetime >= lastconductorpos then
			...
			noteTweenDirection('azazaza04', 0, (90 * ( -thecool[downscroll]) / 0.7) + thecool2[downscroll], 0.5,
				'sineInOut')
	...
	if notetime <= azazazazazazazazazazaza + 3 then
		if notetime >= lastconductorpos then
			...
			noteTweenDirection('azazaza54', 5, (90 * ( -thecool[downscroll]) / 0.7) + thecool2[downscroll], 3.179023,
				'sineInOut')
	...
	if notetime <= azazazazazazazazazazaza + 3 then
		if notetime >= lastconductorpos then
			...
			noteTweenDirection('azazaza74', 7, (90 * ( -thecool[downscroll]) / 0.7) + thecool2[downscroll], 3.439023,
				'sineInOut')
	...
	if notetime <= azazazazazazazazazazaza + 3 then
		if notetime >= lastconductorpos then
			...
			noteTweenDirection('azazaza14', 1, (90 * ( -thecool[downscroll]) / 0.7) + thecool2[downscroll], 6.075273,
				'sineInOut')
	...
	if notetime <= azazazazazazazazazazaza + 3 then
		if notetime >= lastconductorpos then
			...
			noteTweenDirection('azazaza54', 5, (90 * ( -thecool[downscroll]) / 0.7) + thecool2[downscroll], 4.620273,
				'sineInOut')
	...
	if notetime <= azazazazazazazazazazaza + 3 then
		if notetime >= lastconductorpos then
			...
			noteTweenDirection('azazaza64', 6, (90 * ( -thecool[downscroll]) / 0.7) + thecool2[downscroll], 3.217773,
				'sineInOut')
	...
	if notetime <= azazazazazazazazazazaza + 3 then
		if notetime >= lastconductorpos then
			...
			noteTweenDirection('azazaza24', 2, (90.000002 * ( -thecool[downscroll]) / 0.7) + thecool2[downscroll],
				4.295273, 'sineInOut')
